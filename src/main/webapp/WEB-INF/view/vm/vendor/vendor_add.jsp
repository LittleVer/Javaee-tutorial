                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <form:form action="${pageContext.request.contextPath}/vendor.do/add" commandName="vendor" method="post" cssClass="form-horizontal">
                                ...
                                <div class="form-group">
	                                ...
	                                <div class="col-sm-11">
	                                	<button type="button" class="btn btn-default" 
                                			onclick="uploader.singleModal({uploadUrl:'/upload.do/image',type:[{image:['all']}],callback:vendorCallback})">
                                		证件上传</button>
